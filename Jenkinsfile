   ...
   stages {
      ...
      stage('Pre-build dependencies '){
        steps{
            ...
            bat "\"${tool 'MSBuildLocal'}\" sylectus-lib-sylectus-security-util/trunk/Sylectus.SecurityUtil.sln /p:Configuration=Release /p:Platform=\"Any CPU\"  /p:AdditionalLibPaths='sylectus-lib-sylectus/trunk/'  /target:rebuild /p:ProductVersion=1.0.0.${env.BUILD_NUMBER}"
