   ...
   stages {
      ...
      stage('Pre-build dependencies '){
        steps{
            ...
            bat "\"${tool 'MSBuildLocal'}\" sylectus-lib-sylectus/trunk/SylectusLibrary.sln /p:Configuration=Release;Platform=\"Any CPU\";TargetFrameworkVersion=v4.5.2 /target:rebuild /p:ProductVersion=1.0.0.${env.BUILD_NUMBER}"
